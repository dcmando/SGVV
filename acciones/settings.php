            ...
            <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle"
                                    src="data:image/png;base64, <?php echo base64_encode($fotoperfil) ?>">
                            </a>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Estas completando tu perfil <?php echo $nombre_completo; ?></h1>
                        <a href="./realizar_venta.php" class="d-none d-sm-inline-block btn btn-sm btn-success shadow-sm"><i
